package sf.geofencingwithgeofire;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            Log.d("displayLocation", String.format("your location : %f / %f", latitude, longitude));
        } else {
            Log.d("displayLocation", "can not get your location");
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // create dangerous area circle
        LatLng dangerous_area = new LatLng(41.073246, 28.991539);
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                showNotification("HOLA", String.format("%s entered the dangerous area", key));
            }

            @Override
            public void onKeyExited(String key) {
                showNotification("HOLA", String.format("%s is no longer in the dangerous area", key));
            }
